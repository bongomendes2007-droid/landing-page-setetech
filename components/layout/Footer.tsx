...
const SERVICE_LINKS = [
  ...
  { label: 'Infraestrutura & Cloud',     href: '#servicos' },
  { label: 'Marketing Digital',          href: '#servicos' },
  { label: 'Soluções para Órgãos Públicos', href: '#servicos' },
]
      ...
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            >
              Tecnologia que move negócios regionais para o futuro. Teresina, Piauí.
            </p>
        ...
        <div
          ...
          style={{ borderTop: '1px solid var(--color-border)', color: 'var(--color-subtle)', fontFamily: 'var(--font-dm-sans)' }}
        >
          <p>&copy; {year} SETE TECH. Todos os direitos reservados.</p>
          <p>
            Feito com{' '}
